...
do
	return function(UI)
		...
		-- [2] MODULE STATE
		local ModuleName = "InfoTab"
		local Variables = {
			Maids = { [ModuleName] = Maid.new() },
			-- This module's state is self-contained in the logic block
		}
		...
		-- [3] CORE LOGIC & UI CREATION
		-- This logic runs immediately when the module is loaded
		pcall(function()
